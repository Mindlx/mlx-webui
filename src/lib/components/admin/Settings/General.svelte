		...
		{#if adminConfig !== null}
					...
					<div class="flex items-start justify-between gap-4">
						<div class="min-w-0">
							...
							<div class="mt-0.5 text-gray-400 dark:text-gray-600">
								{$i18n.t('Discover how to use MindLynx Agent and seek support from the community.')}
							</div>
						</div>
			...
			<AdminSettingSection title={$i18n.t('Features')}>
				<AdminSettingRow
					...
					description={$i18n.t('Allow users to share chats with the MindLynx Agent community.')}
					let:labelId
				>
